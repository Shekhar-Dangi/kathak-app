...
When we take a couple of similar words and arrange/rearrange those to make different rhythm, that is called Baat <br />
  <List list = {[
    "Baat 1 - 16 Tatkar", 
    "Baat 2 - Ta Thei Tat Ta Thei Thei Tat… ", 
    "Baat 3- Takita Takita Taka…  "
    ]} />
</p>
...
<p className="paragraph">
  Specialities of Gaat: <br />
  <List list={["Gaat is danced in Drut Laya but we stop half of its beat",
...
We show different Layas while dancing different boles but we show the whole Layakari in the beginning of our dance recital. In Layakari we don’t use any movements. There are only 3 layas in kathak but there are many “layakari” in Kathak
</p>
...
<p className="paragraph">
Prattangya:<br />
It comprises all types of joints which we can fold/use during dance. There are 9 different types of Prattangya. 
<List list={["Neck",
  "Shoulder" ,
  "Elbow",
  "Wrist",
...
Salami v.s. Aamad <br />
Differences:
<List list={["Salami means salutations and Aamad means entrance",
  "In Salami we do not have symmetrical movement but in Aamad we do" ,
  "In Salami we do salam and namaste but in Aamad we do  not"
  ]} />
Similarities:
<List list={["Both are in the beginning of Vilambit Laya",
  "Both are in the beginning of the recital" ,
  "They are both in Nritta"
  ]} />
</p>
...
Tallipi Padhyati:<br />
2 Types: <br />
<List list={["Vishnudigambar Tallipi Padhyati(VTP)",
  "Bhatkhande Tallipi Padhyati(BTP)"
  ]} />
